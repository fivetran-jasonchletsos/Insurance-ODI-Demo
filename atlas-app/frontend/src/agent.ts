// ============================================================
// Atlas Risk Underwriting Copilot — local rules tier + optional Claude tier.
...
const SYSTEM = `You are a senior underwriter at Atlas Risk, a commercial insurance and reinsurance advisory.
