    ...
    <div className="px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
      <div className="mx-auto max-w-6xl mb-10">
        ...
        <p className="mt-3 max-w-3xl leading-relaxed" style={{ color: 'var(--ink-muted)' }}>
          The agent reads the same Apache Iceberg gold tables in s3:// that Athena and DuckDB read
          for the rest of Verity Insurance. No copy, no separate AI data product, no vendor-controlled
          gateway — the lake is the contract; the agent is one more engine that plugs in.
        </p>
      </div>
      <AskPanel />
    </div>
