/*
 * WizardLivePage — dbt-wizard live-build playback for Verity Insurance.
 *
...
const STEP_DEFS = [
  ...
  { label: 'Materialization',      who: 'Worker + Ver', tools: 'dbt_run, lineage',        insight: '312 rows · snowflake'  },
];

// Agent accent colors aligned with Verity Insurance palette
    ...
    <div className="wizard-terminal mx-auto max-w-[1640px] px-4 py-4 sm:px-6 lg:px-8">
      ...
      <div
        ...
        style={{
          ...
          borderLeft: '4px solid var(--clinical-teal, #0d9488)',
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <span
            ...
            style={{
              ...
              background: 'rgba(13,148,136,0.1)', color: 'var(--clinical-teal, #0d9488)', border: '1px solid rgba(13,148,136,0.35)',
            }}
          >
            <span
              style={{
                display: 'inline-block', width: 8, height: 8, borderRadius: 999,
                background: 'var(--clinical-teal, #0d9488)',
          ...
          <span className="font-mono" style={{ color: 'var(--ink-muted)', fontSize: 13 }}>
            Step{' '}
            <span style={{ color: 'var(--clinical-teal, #0d9488)', fontWeight: 700 }}>{currentStep}/{totalSteps}</span>
          ...
          >
            <div
              style={{
                ...
                height: '100%',
                background: complete ? '#145e36' : 'var(--clinical-teal, #0d9488)',
      ...
      <div
        ...
        style={{ borderLeftColor: 'var(--clinical-teal, #0d9488)' }}
      >
        <div className="min-w-0 flex-shrink" style={{ flex: '1 1 460px' }}>
          <div className="eyebrow" style={{ fontSize: 10, marginBottom: 2, color: 'var(--clinical-teal, #0d9488)' }}>
            Cat Analytics · {scenario.timezone_label} · {scenario.requested_by}
          </div>
          <p
        ...
        <div className="font-mono text-[var(--ink-muted)] shrink-0" style={{ fontSize: 11 }}>
          Target: <span style={{ color: 'var(--clinical-teal, #0d9488)', fontWeight: 700 }}>{scenario.metric_code}</span>
        </div>
      </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  color: active ? 'var(--clinical-teal, #0d9488)' : done ? '#145e36' : 'var(--ink-soft)',
                }}
              >
                      ...
                      <div className="flex items-center gap-2 flex-wrap mb-1.5">
                        ...
                        <span
                          ...
                          style={{
                            ...
                            background: 'rgba(13,148,136,0.10)', color: 'var(--clinical-teal, #0d9488)',
        ...
        <section className="flex flex-col gap-3 lg:!h-[calc(100dvh-440px)]" style={{ minHeight: 'max(60vh, 300px)' }}>
            ...
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="eyebrow font-mono" style={{ fontSize: 11, letterSpacing: '0.02em' }}>
                  models/gold/fct_cat_wind_severity_by_tier_region_daily.sql
                </div>
                <span
          ...
          <div className="clinical-card flex flex-col" style={{ flex: '1 1 0' }}>
            ...
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="eyebrow font-mono" style={{ fontSize: 11, letterSpacing: '0.02em' }}>
                  models/gold/fct_cat_wind_severity_by_tier_region_daily.yml
                </div>
                <span
                  className="layer-chip"
                  style={{
              ...
              >
                <span
                  style={{
                    ...
                    background: i === 0 ? 'var(--clinical-teal, #0d9488)' : 'var(--ink-soft)',
        ...
        >
          <div className="flex items-baseline justify-between flex-wrap gap-3 mb-1">
            ...
            <Link
              ...
              style={{
                background: 'var(--clinical-teal, #0d9488)', color: '#fff',
      ...
      <style>{`
        ...
        .wizard-terminal::after {
          content: 'verity-insurance/wizard-live · dbt-wizard';
          position: absolute;
          top: 0; left: 0; right: 0;
          height: 28px;
          display: flex;
        ...
        .wizard-terminal .clinical-card[style*="rgba(20,94,54"] {
...
const SQL_KEYWORDS = new Set([
  ...
  'sum', 'max', 'min', 'avg', 'dateadd', 'current_date', 'is', 'not', 'coalesce',
  'date_part', 'year',
]);
