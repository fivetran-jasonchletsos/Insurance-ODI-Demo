  ...
  const layers: Record<FailureKey, LayerState> = useMemo(() => {
    ...
    return {
      connectors: f.has('connectors')
        ? { ok: false, status: 'sync failed', detail: 'Fivetran custom connectors — NAIC · NOAA Storm Events · OpenFEMA NFIP.', failureDetail: 'Simulated: NOAA Storm Events API rate-limit hit on catastrophe sync. Retry scheduled in 15m.' }
    ...
    return [
      {
        ...
        dashboard_url: 'https://fivetran.com/dashboard/connectors/granite_rocky',
      ...
      },
      {
        ...
        dashboard_url: 'https://fivetran.com/dashboard/connectors/intentional_began',
        destination: 'S3 Iceberg',
