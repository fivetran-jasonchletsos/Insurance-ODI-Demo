...
//
// Verity Insurance fork: footer reads "Telematics streams via Kafka"
// (not HL7/Kinesis); governance band reads "SOC 2 · NAIC · row-level
// access · column masking" (not HIPAA).
...
export interface SourceNode {
  id: string;
  label: string;     // "Policy Admin System"
  sub: string;       // "SQL Server log-CDC"
  logo?: VendorLogo;
  freshness?: string;          // "52s lag"
  status?: NodeStatus;
  streaming?: boolean;
  lagP99?: string;
  pipelineUrl?: string;
...
export interface ConsumerRole {
  label: string;     // "Underwriters"
  sub?: string;      // "risk pricing"
}
      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> 81% no-op syncs <span style={{ color: '#9ca3af' }}>·</span> Telematics streams via Kafka</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">SOC 2 · NAIC · row-level access · column masking</span>
          </div>
